...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_email_folders_account_id"),
        "email_folders",
        ["account_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_email_messages_account_id"),
        "email_messages",
        ["account_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_email_messages_folder_id"),
        "email_messages",
        ["folder_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_email_messages_is_archived"),
        "email_messages",
        ["is_archived"],
        unique=False,
    )
    op.create_index(
        op.f("ix_email_messages_is_deleted"),
        "email_messages",
        ["is_deleted"],
        unique=False,
    )
    op.create_index(
        op.f("ix_email_messages_is_sent"), "email_messages", ["is_sent"], unique=False
    )
    op.create_index(
        op.f("ix_email_messages_message_id_header"),
        "email_messages",
        ["message_id_header"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_email_attachments_message_id"),
        "email_attachments",
        ["message_id"],
        unique=False,
    )
