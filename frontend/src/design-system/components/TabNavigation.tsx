...
export const TabNavigation = React.memo<TabNavigationProps>(({
  ...
  return (
    <div
      className={cn(
        'inline-flex items-center gap-1 bg-surface-2 p-1 rounded-lg border border-border shadow-subtle',
        ...
        return (
          <button
            ...
            className={cn(
              ...
              isActive
                ? 'bg-surface text-primary shadow-subtle scale-[1.02]'
            ...
            {tab.badge !== undefined && tab.badge > 0 && (
              <span
                className={cn(
                  ...
                  isActive ? 'bg-primary text-primary-foreground shadow-subtle' : 'bg-border text-muted-foreground'
                )}
